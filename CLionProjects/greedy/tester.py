...
# EXE = '../cmake-build-debug/CLionProjects' # Executavel gerado pela compilação dos arquivos que realmente resolvem o problema
EXE = './g' # Executavel gerado pela compilação dos arquivos que realmente resolvem o problema
