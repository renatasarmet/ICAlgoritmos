...
private:
	...
	double solve_all_scenarios(double (*decode_Ap)(EF::SP_instance &, int, std::vector <bool>&, std::vector <double> &,std::vector <bool>&),
...
public:
	...
	int solve(double (*decode_Ap)(EF::SP_instance &, int, std::vector <bool>&, std::vector <double> &,std::vector <bool>&),
