...
-------- ALGORITMO DE BUSCA TABU COM LATE ACCEPTANCE --------
...
g++ handlesInput.cpp LATabuSearch.cpp -o lats -Ofast

quando estiver usando classe:
(g++ handlesInput.cpp LATabuSearch.cpp ../global/Solution.cpp ../global/Instance.cpp -o lats -Ofast)
...
./lats input_name initialSolName solutionName input_type best_fit a1 lc1 lc2 lo1 lo2
