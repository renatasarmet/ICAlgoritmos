...
int main(int argc, char *argv[]){
	...
	*/
	...
	for(int i=0;i<qty_facilities;i++){
		solution.open_facilities[i] = false; // todas começam fechadas
	}
	...
	for(int i=0;i<qty_clients;i++){
		...
		solution.open_facilities[solution.assigned_facilities[i]] = true; // marcando quais estao abertas
  ...
  /*
	...
	******************************************/
	...
	// Temporario, depois transformar o costA nesse assigment_cost
	...
	solution = LSCloseFac(solutionName, qty_facilities, qty_clients, costF, assignment_cost, solution);
